...
| Phase 4 — Type-3 UAT Certification | ⏳ READY TO RUN | `scripts/type3_uat_sanity.py` | §A11 UAT sanity pack generator implemented (ITR-1 ×2 + ITR-4 ×3 variants, real `SW20014122` + round-tripping Digests, `sanity_manifest.json`). Run it, email JSONs to `erihelp@incometax.gov.in`, await ITD SW_ID enablement. |
