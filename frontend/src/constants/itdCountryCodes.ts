export interface CountryCodeOption { value: string; label: string; }

export const ITD_COUNTRY_CODES: CountryCodeOption[] = [
  { value: '1001', label: 'Ã…LAND ISLANDS' },
  ...
  { value: '225', label: 'CÃ”TE D\'IVOIRE' },
  { value: '385', label: 'CROATIA' },
  { value: '53', label: 'CUBA' },
  { value: '1015', label: 'CURAÃ‡AO' },
  ...
  { value: '670', label: 'TIMOR-LESTEÂ (EAST TIMOR)' },
