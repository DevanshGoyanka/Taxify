/** Official AY 2026-27 ITR-4 nature-of-business code lists. */
export type OfficialCodeOption = readonly [code: string, description: string];

export const NATURE_CODES_44AD: readonly OfficialCodeOption[] = [
...
export const NATURE_CODES_44ADA: readonly OfficialCodeOption[] = [
...
export const NATURE_CODES_44AE: readonly OfficialCodeOption[] = [
  ["08001", "Renting of land transport equipment"],
  ["11002", "Packers and movers"],
  ["11008", "Freight transport by road"],
  ["11010", "Forwarding of freight"],
