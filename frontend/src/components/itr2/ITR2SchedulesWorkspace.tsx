...
function controlFor(section: string, key: string, row: Row, onValue: (value: unknown) => void): React.ReactElement {
  ...
  if (key === 'form67Filed' || key === 'form10FFiled') {
