...
export function PersonalInfoTab({ draft, itrForm, onChange, onBanksChange, onRegimeChange }: PersonalInfoTabProps): React.JSX.Element {
  ...
  return <div>
    ...
    <div style={CARD_STYLE}>
      ...
      {filing.seventhProviso.foreignTravel && <Field label="Foreign-travel expenditure (₹)" value={moneyValue(filing.seventhProviso.foreignTravelAmount)} onChange={(value) => updateFiling({ seventhProviso: { ...filing.seventhProviso, foreignTravelAmount: parseMoney(value) } })} type="number" required min={200000} help="Must be at least ₹2,00,000 — this declaration is only applicable above that threshold." />}
