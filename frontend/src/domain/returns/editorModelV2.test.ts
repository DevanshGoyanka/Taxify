...
describe('ReturnEditorModelV2', () => {
  ...
  it('updates all ITR-2 additive schedules immutably', () => {
    ...
    const foreignSourceIncome = [{ id: 'fsi-1', countryName: '', countryCode: 'US', taxIdentificationNo: 'TIN', salaryIncome: 100, hpIncome: 0, businessIncome: 0, cgIncome: 0, osIncome: 0, taxPaidOutsideIndia: 10, taxPayableInIndia: 12, reliefSection: '90' as const, treatyArticle: '' }];
    const foreignTaxRelief = [{ id: 'tr-1', countryName: '', countryCode: 'US', taxIdentificationNo: 'TIN', incomeIncludedInThisReturn: 100, taxPaidOutsideIndia: 10, indianTaxPayable: 12, reliefClaimed: 10, reliefSection: '90' as const, form67Filed: true, form10FFiled: false }];
    const foreignAssets = [{ id: 'fa-1', assetType: 'BANK_ACCOUNT' as const, countryName: '', countryCode: 'US', institutionOrEntityName: 'Bank', address: 'A', zipCode: '00000', accountOrAssetIdentifier: '1', ownershipStatus: 'OWNER', openingOrAcquisitionDate: '2025-04-01', peakValue: 10, closingValue: 8, grossIncome: 0, incomeOffered: 0, natureOfAsset: '', natureOfIncome: '', incomeTaxScheduleItemNo: '', initialValueOfInvestment: null, totalGrossProceedsValue: 0 }];
    ...
    const portugueseCivilCode = { spouseName: 'Spouse', spousePAN: 'ABCDE1234F', spouseAadhaar: '', hpAmountApportioned: 1, cgAmountApportioned: 2, osAmountApportioned: 3, hpTdsApportioned: 4, cgTdsApportioned: 5, osTdsApportioned: 6 };
