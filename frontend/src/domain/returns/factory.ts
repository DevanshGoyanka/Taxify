...
export function createEmptyReturnDraft(assessmentYear = '', form: ReturnDraft['form'] = 'ITR-1', regime: ReturnDraft['regime'] = 'new'): ReturnDraft {
  return {
    ...
    itr3AuditInfo: {
      ...
      auditorPAN: '', auditorAadhaar: '', liableSec92E: 'N', auditedUnder92E: 'N', accountAudit: 'N',
      auditReport92EDate: null, acknowledgement92E: '',
      auditUnderOtherActEntries: [], otherAuditReportEntries: [],
    },
    itr3NatureOfBusiness: [],
    itr3BalanceSheet: {
      proprietorCapital: 0, reservesAndSurplus: 0, securedLoans: 0, unsecuredLoans: 0,
      deferredTaxLiability: 0, advancesFromCustomers: 0, totalSources: 0,
      fixedAssets: 0, investments: 0, inventories: 0, tradeReceivables: 0, cashAndBank: 0, loansAndAdvances: 0,
      creditors: 0, provisions: 0, otherAssets: 0, totalApplications: 0, noBooksOfAccounts: false,
      noBooksSundryDebtors: 0, noBooksSundryCreditors: 0, noBooksStockInTrade: 0, noBooksCashBalance: 0,
    ...
    filing: {
      ...
      kartaPan: '',
      seventhProvisoApplies: false, optOldRegimeCurrAY: '',
      isPartnerInFirm: false, partnerInFirmEntries: [],
      nriPEinIndia: '', nriSEPinIndia: '', aggrPaymentTransac: 0, numberOfUsers: 0,
      foreignExchangeFlag: '',
    },
