...
def _schedule_si(result: ITR2Result) -> Optional[dict[str, Any]]:
    ...
    for entry in si.entries:
        ...
        rows.append({
            ...
            "SplRateIncTax": _to_rupees_rounded10(entry.tax_amount),
        })
    return {
        "SplCodeRateTax": rows,
        "TotSplRateInc": _to_rupees(si.total_special_rate_income),
        "TotSplRateIncTax": _to_rupees_rounded10(si.total_special_rate_tax),
    }
    ...
    return {
        "ComputationOfTaxLiability": {
            ...
            "IntrstPay": {
                ...
                "FeeFurnish234I": 0,
                "TotalIntrstPay": _to_rupees_rounded10(total_interest),
            },
