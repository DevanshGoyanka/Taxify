    ...
    return {
        "ComputationOfTaxLiability": {
            "TaxPayableOnTI": {
                ...
                "TotalSurcharge": 0,
                "EducationCess": 0,
                "GrossTaxLiability": _to_rupees_rounded10(result.slab_tax + result.special_rate_tax),
            },
            "TaxRelief": {"Section89": _to_rupees_rounded10(result.relief_89),
            ...
            "IntrstPay": {"IntrstPayUs234A": _to_rupees_rounded10(result.interest_234a),
                          "IntrstPayUs234B": 0, "IntrstPayUs234C": 0,
                          "LateFilingFee234F": _to_rupees_rounded10(result.late_fee_234f),
                          "FeeFurnish234I": 0, "TotalIntrstPay": _to_rupees_rounded10(result.total_interest + result.late_fee_234f)},
